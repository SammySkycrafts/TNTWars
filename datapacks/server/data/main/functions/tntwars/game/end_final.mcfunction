...
execute as @e[tag=randomize_teams] at @s run setblock ~ ~ ~ blackstone_wall
execute as @e[tag=randomize_teams] at @s run setblock ~ ~1 ~ stone_button[face=floor]
...
execute as @e[tag=game_starter] run data merge entity @s {CustomNameVisible:1b,CustomName:'{"text":"WAITING FOR PLAYERS","color":"red","bold":true}'}
execute as @e[tag=game_countdown] run data merge entity @s {CustomNameVisible:1b,CustomName:'{"text":"1 player per team required.","color":"red","bold":false}'}
execute as @e[tag=game_starter] at @s run setblock ~ ~-1 ~ blackstone_wall
execute as @e[tag=game_starter] at @s run setblock ~ ~ ~ warped_button[face=floor]
...
execute as @a[tag=autoqueue] at @s run tellraw @s [{"text":"AUTOQUEUE","color":"dark_green","bold":"true"},{"text":" You were automatically added to the queue. Do /queue to leave it!","color":"green","bold":"false"}]
