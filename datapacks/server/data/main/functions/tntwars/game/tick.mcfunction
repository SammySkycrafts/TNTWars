...
execute if score tntwars_timer global matches 2 as @e[tag=game_countdown] run data merge entity @s {CustomName:'{"text":"3","color":"yellow","bold":false}'}
execute if score tntwars_timer global matches 3 as @e[tag=game_countdown] run data merge entity @s {CustomName:'{"text":"2","color":"yellow","bold":false}'}
execute if score tntwars_timer global matches 4 as @e[tag=game_countdown] run data merge entity @s {CustomName:'{"text":"1","color":"yellow","bold":false}'}
execute if score tntwars_timer global matches 5 as @e[tag=game_countdown] run data merge entity @s {CustomName:'{"text":"Starting","color":"yellow","bold":false}'}
